  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      <div className="mb-8">
        ...
        <h2 className="font-heading text-2xl font-semibold text-ink mt-6">Welcome back</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="login-password" className="block text-sm font-medium text-ink mb-1.5">Password</label>
          <div className="relative">
      ...
      <div className="mt-4">
        ...
        <button onClick={handleGoogleLogin} className="btn-secondary w-full mt-4 flex items-center justify-center gap-2">
